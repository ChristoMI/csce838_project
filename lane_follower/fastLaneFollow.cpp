...
#include "real_car_lane_follow/CarObject.h"
#include "real_car_lane_follow/CarObjects.h"
...
class LaneFollower{
    ...
    LaneFollower():image_transport(n) {
        ...
        object_detection_pub = n.advertise<real_car_lane_follow::CarObjects>(object_detection_topic,10);
        // Load pytorch model
        try {
  ...
  void image_callback(const sensor_msgs::ImageConstPtr& msg){
      ...
      real_car_lane_follow::CarObjects objectsDetected;
      bool foundCar = false;
      long minX= 256;
      long maxX=0;
      long minY = 256;
    ...
    //TEST DATA
    real_car_lane_follow::CarObject testObject;
    if(foundCar){
